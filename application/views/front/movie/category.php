...
<div class="movies col-sm-9">
	...
	<div class="movie_frame latest_movies">
		<div class="title"><span>Movies</span></div>
		<ul class="movie_list">
			<?php foreach($Movies as $Movie){?>
			<li>
				<div class="poster"><a href="<?php echo site_url("movie/").$Movie["UrlName"];?>"><img src="<?php echo base_url().$Movie["Image"];?>" alt="<?php echo $_Movie["Name"];?>"/></a></div>
